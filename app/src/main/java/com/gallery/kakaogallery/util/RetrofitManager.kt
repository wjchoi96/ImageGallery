...
class RetrofitManager private constructor() {
    ...
    private val KAKAO_REST_API_KEY = AppHelper.instance.getString(R.string.kakao_rest_api_key)
    ...
    private fun initOkHttpClient() {
        val cache = Cache(AppHelper.instance.cacheDir, (5 * 1024 * 1024).toLong()) // 5mb => 캐시 용량은 한번 더 생각해서 설정해보자
